...
import { cancelarReserva, crearReserva, generarQrCodeInvitacion, generarQrCodeAcceso, reprogramarReserva, obtenerMisReservas, terminarReserva } from '../controllers/reservasController'
...
router.get('/:reservaId/terminar', terminarReserva)
